...
public class PapilioArguments
{
	 ...
	 * Db server host.
	 */
	@CliArgument(name = "h", longName = "host", description = "Db server host", required = true)
	private String host;
	
	/**
	 * Db server port.
	 */
	@CliArgument(name = "p", longName = "port", description = "Db server port", required = true)
	 ...
	 *
	 * @param host the new db server host
	 */
	 ...
	 *
	 * @param port the new db server port
	 */
	 ...
	 *
	 * @param dbname the new default database to be used
	 */
	 ...
	 *
	 * @param userName the new username to be used for authentication
	 */
	 ...
	 *
	 * @param changeLogFile the new change log file to be processed
	 */
